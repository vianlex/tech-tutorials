...
````markdown {title="源码"}
```gallery
![OINK 的默认文档外壳](/images/oink.webp) # 点击进入「图片」组件页 {link=/zh/docs/image/}
![发布说明页面](/images/releasenote.webp) # 点击进入「发布与下载」 {link=https://oink.pgsty.com/zh/docs/write/releases/}
```
````
...
![OINK 的默认文档外壳](/images/oink.webp) # 侧栏、正文、目录
```
