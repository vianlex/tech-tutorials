...
- [hugo.yaml](https://github.com/pgsty/oink/blob/main/tests/site/hugo.yaml)   # site configuration on GitHub
```
````
...
- [Organizing content](https://oink.pgsty.com/docs/write/organize/) — how a real content directory is laid out
