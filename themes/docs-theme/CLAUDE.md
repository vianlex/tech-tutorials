...
Guidance for working in `github.com/pgsty/docs`.

## Repository boundary

This repository is the Docs Hugo Module: layouts, partials, shortcodes, SCSS,
...
The sibling `../docs.pgsty.com` repository owns the public bilingual product
...
public site pins a released Docs tag; local cross-repo validation uses an inline
...
From `../docs.pgsty.com`, validate and preview the real bilingual site with the
...
```sh
python3 bin/migrations/docs06.py report --sites <dir>...
python3 bin/migrations/docs06.py migrate --site <dir> [--write]
python3 bin/migrations/docs06.py check --site <dir>
