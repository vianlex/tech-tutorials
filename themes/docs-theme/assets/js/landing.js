...
(function (factory) {
  'use strict';
  var api = factory();
  if (typeof window !== 'undefined') window.DocsLanding = api;
  ...
  function writeClipboard(text, doc, nav) {
    var clipboard = typeof window === 'object' ? window.DocsClipboard : globalThis.DocsClipboard;
  ...
  function initMobileMenu(root, win, doc) {
    ...
    var coordinator = win && win.DocsSurfaceCoordinator;
