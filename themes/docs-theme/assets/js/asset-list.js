/** Docs release asset checksum copy controls. */
(function (global) {
  'use strict';
  ...
  function writeClipboard(text, doc) {
    return global.DocsClipboard.writeText(text, doc, global.navigator);
  }
  ...
  function copyFromControl(button, doc) {
    ...
    return writeClipboard(text, doc).then(function () {
      ...
      if (global.console && typeof global.console.error === 'function') {
        global.console.error('Docs asset list: unable to copy checksums:', error);
      }
      return false;
    });
  }
  ...
  global.DocsAssetList = api;
  if (typeof module === 'object' && module.exports) module.exports = api;
  if (!global.__Docs_ASSET_LIST_MANUAL_INIT__ && global.document) {
