...
(function (global) {
  ...
  function initSearch(options) {
    ...
    var registry = options.registry || global.DocsActions;
    var model = options.model || global.DocsPaletteModel;
    var searchApi = options.searchApi || global.DocsSearchEngine;
    ...
    function open(event, seed) {
      ...
      lastOpener = opener;
      if (global.DocsSurfaceCoordinator)
        global.DocsSurfaceCoordinator.closeOthers('palette');
    ...
    if (global.DocsSurfaceCoordinator)
      global.DocsSurfaceCoordinator.register('palette', close);
  ...
  global.DocsCommandPalette = {
    init: initSearch,
    commandPrefix: COMMAND_PREFIX,
  };
  if (typeof module === 'object' && module.exports)
    module.exports = global.DocsCommandPalette;
  if (!global.__Docs_PALETTE_MANUAL_INIT__)
    global.DocsCommandPalette.instance = initSearch();
