/*
 * Docs compatibility patch based on Bootstrap PR #41726:
...
(function () {
  ...
  if (typeof bootstrap === 'undefined' || !bootstrap.ScrollSpy) {
    console.warn('[Docs] ScrollSpy patch: Bootstrap not found, patch skipped');
    return;
  }
  ...
  if (!ScrollSpy.prototype._initializeTargetsAndObservables) {
    console.warn(
      '[Docs] ScrollSpy patch: _initializeTargetsAndObservables method not found, patch skipped',
    );
    return;
  }
