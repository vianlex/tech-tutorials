...
(function () {
  ...
  function initRootMenu() {
    ...
    function open() {
      ...
      if (window.DocsSurfaceCoordinator)
        window.DocsSurfaceCoordinator.closeOthers('root-menu', ['drawer']);
      pop.hidden = false;
    ...
    if (window.DocsSurfaceCoordinator)
      window.DocsSurfaceCoordinator.register(
        'root-menu',
  ...
  function initDrawer() {
    ...
    function open(event) {
      if (window.DocsSurfaceCoordinator)
        window.DocsSurfaceCoordinator.closeOthers('drawer');
    ...
    if (window.DocsSurfaceCoordinator)
      window.DocsSurfaceCoordinator.register('drawer', close);
    function close(restoreFocus) {
