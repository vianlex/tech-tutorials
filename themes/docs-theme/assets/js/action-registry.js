...
(function (global) {
  ...
  function create(options) {
    ...
    var clipboard = options.clipboard || windowObject.DocsClipboard || global.DocsClipboard;
    var fetchApi =
      options.fetch ||
      (windowObject.fetch
  ...
  global.DocsActionRegistry = api;
  if (global.document) global.DocsActions = create();
