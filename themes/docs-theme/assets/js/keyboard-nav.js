...
(function (global) {
  ...
  function init(options) {
    ...
    function registry() {
      return options.registry || global.DocsActions || null;
    }

    function palette() {
      return options.palette || global.DocsCommandPalette || null;
    }
    ...
    function openPalette(event, commandMode) {
      ...
      // the requested mode once the full Docs runtime has initialized there.
  ...
  global.DocsKeyboardNav = api;
  if (typeof module === 'object' && module.exports) module.exports = api;
  if (!global.__Docs_KEYBOARD_NAV_MANUAL_INIT__ && global.document) init();
