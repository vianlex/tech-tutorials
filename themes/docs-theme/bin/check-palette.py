...
def main() -> int:
    try:
        ...
        with tempfile.TemporaryDirectory(prefix="docs-palette-") as temporary:
            ...
            for deployment, subpath, prefix in (
                ...
                for lang in helper.LANGUAGES:
                    ...
                    require(
                        any("DocsPaletteModel" in bundle for bundle in bundles),
                        f"{deployment}/{lang} referenced bundle omitted the result model",
                    )
                    require(
                        any("DocsCommandPalette =" in bundle for bundle in bundles),
