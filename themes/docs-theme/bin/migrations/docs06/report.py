...
def render_markdown(report: dict) -> str:
    sites = report["sites"]
    lines: list[str] = []
    lines.append(f"# Docs 0.6 migration inventory — {report['generated_at']}")
    lines.append("")
    lines.append("Read-only dry-run of `bin/migrations/docs06.py` over the listed sites. Counts are conversions the")
