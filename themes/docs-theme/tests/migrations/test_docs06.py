"""Freeze the Docs 0.6 migration toolkit: before/after fixtures per transformation,
...
from docs06.cli import migrate_text, residual_findings  # noqa: E402
from docs06.transforms import load  # noqa: E402

CLI = ROOT / "bin" / "migrations" / "docs06.py"
...
class TransformationCase(unittest.TestCase):
    ...
    def test_raw_details(self):
        counts, _ = self.assertMigrates(
            """\
            <details>
            <summary><code>docs</code> scorecard</summary>
