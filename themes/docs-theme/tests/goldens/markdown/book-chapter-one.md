...
[Figure 1-2](#fig-artifact) is that page, and chapter two
...
Note that [Table 1-2](#tbl-outputs) names a file for every
...
[Equation 1.2](#eq-weighted) reduces to
[Equation 1.1](#eq-coverage) when every surface is rebuilt equally
