...
with direction and conditions, use [Mermaid](/docs/mermaid/).
...
- [theme repository](https://github.com/pgsty/docs)
- [site source](https://github.com/pgsty/docs.pgsty.com)
```
````
...
[Configuration](https://docs.pgsty.com/docs/customize/config/). Per-map
...
- [Mermaid](/docs/mermaid/) — diagrams with direction and conditions
- [File trees](/docs/filetree/) — more precise for directory structure
- [Callouts](/docs/callout/) — everything `[!DETAILS]` can do
- [Configuration](https://docs.pgsty.com/docs/customize/config/) — `params.markmap`
