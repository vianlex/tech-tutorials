...
[发布说明](https://github.com/pgsty/docs/releases/tag/{{</* param tdVersion.latest */>}})
````
...
站点参数在哪里定义、有哪些可用，见[配置总览](https://docs.pgsty.com/zh/docs/customize/config/)；页面参数见[页面参数](https://docs.pgsty.com/zh/docs/write/frontmatter/)。
...
- [代码块](/zh/docs/code/) — 围栏的全部属性，`include code=true` 用的是同一套渲染
- [标签页](/zh/docs/tabs/) — 按平台 / 语言分版本的片段
- [配置总览](https://docs.pgsty.com/zh/docs/customize/config/) — `param` 能取到的站点参数
- [页面参数](https://docs.pgsty.com/zh/docs/write/frontmatter/) — 页面级参数，优先于站点配置
