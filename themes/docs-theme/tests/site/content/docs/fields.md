...
| Content that is a sequence of actions | [Steps](/docs/steps/) |

The table form stays a readable table on GitHub, and Docs's Markdown output
...
- [Tables](/docs/table/) — the rest of the attribute line and the exclusion rules
- [Configuration](https://docs.pgsty.com/docs/customize/config/) — the full site parameter table, itself a field list
- [Front matter](https://docs.pgsty.com/docs/write/frontmatter/) — the full front matter table
- [Steps](/docs/steps/) — ordered actions do not belong in a field list
