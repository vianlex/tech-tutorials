...
The first five match GitHub; the other five are semantic types Docs adds. Every
...
> [!QUESTION]
> Should the site have comments? See [enabling comments](https://docs.pgsty.com/docs/admin/comments/).
...
>
> 1. Clone: `git clone https://github.com/pgsty/docs.pgsty.com my-docs`
...
- Callouts work inside `{.steps}` list items and `{{%/* steps */%}}` steps (see
  [Steps](/docs/steps/)); every line of the blockquote starts with
  `>` and lines up with the list item's indent.

## Related {#related}

- [Steps](/docs/steps/) — callouts inside a procedure
- [Tabs](/docs/tabs/) — the same note split per platform
- [Writing pages](https://docs.pgsty.com/docs/write/pages/) — when to use a callout and when to use prose
