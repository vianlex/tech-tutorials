...
[keyboard navigation](https://docs.pgsty.com/docs/customize/keyboard/).
...
- [Keyboard navigation](https://docs.pgsty.com/docs/customize/keyboard/) — the full shortcut list and its switches
- [Command palette](https://docs.pgsty.com/docs/customize/panel/) — what {{< kbd "Ctrl" "K" >}} opens
