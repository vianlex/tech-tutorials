...
[image](/docs/image/), and images with no order or comparison between
...
```gallery
![Docs's default documentation shell](/images/docs.webp)
...
````markdown {title="Source"}
```gallery
![The three-column layout of an Docs page](/images/docs.webp) # The default shell: sidebar, article, table of contents
...
````markdown {title="Source"}
```gallery
![Docs's default documentation shell](/images/docs.webp) # Opens the Images component page {link=/docs/image/}
![A release notes page](/images/releasenote.webp) # Opens "Releases and downloads" {link=https://docs.pgsty.com/docs/write/releases/}
```
````
...
````markdown {title="Source"}
```gallery
![Docs documentation overview](/images/docs.webp) # From static/images/…, published as is
![Docs release notes](/images/releasenote.webp) # Shared from the same simple directory
```
````
...
details are in [Images · Zoom](/docs/image/#zoom).
...
````markdown {title="Source"}
```gallery {tab="Docs" group="shell" value="docs"}
![Docs's default documentation shell](/images/docs.webp) # Sidebar, article, table of contents
```
...
- [Images](/docs/image/) — single images, captions, numbering, the zoom switch
- [Cards](/docs/cards/) — a grid of links with images
- [Tabs](/docs/tabs/) — one gallery per platform or theme
- [File trees](/docs/filetree/) — the same line syntax family
