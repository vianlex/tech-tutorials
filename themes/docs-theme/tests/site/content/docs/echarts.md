...
weight: 150
search_keywords: [ECharts, chart, bar, line, pie, height, theme, DocsEchartsFunctions]
---
...
Give `radius` two values for a doughnut. Below is how Docs's 29 shortcodes break
down by purpose.
...
options and register that name on `window.DocsEchartsFunctions`:
...
[release page](https://docs.pgsty.com/docs/write/releases/).
