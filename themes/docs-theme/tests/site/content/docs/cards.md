...
- [Get started](https://docs.pgsty.com/docs/start/) — Clone this documentation site, delete what you do not need, replace the site details with your own.
- [Authoring](https://docs.pgsty.com/docs/write/) — How pages are organized and which front matter keys exist.
- [Customization](https://docs.pgsty.com/docs/customize/) — Navigation, search, branding, languages.
{.cards}
```
...
```markdown {title="Source"}
- [Front matter](https://docs.pgsty.com/docs/write/frontmatter/)

  Every page parameter is defined here exactly once: type, default, accepted
  values, and the page that explains it.

- [Configuration](https://docs.pgsty.com/docs/customize/config/)
...
```markdown {title="Source"}
{{</* cards */>}}
{{</* card title="Get started" link="https://docs.pgsty.com/docs/start/" icon="fa-solid fa-rocket" badge="start here" */>}}
Fork the documentation site itself and get a local preview in ten minutes.
{{</* /card */>}}
{{</* card title="Release and download pages" link="https://docs.pgsty.com/docs/write/releases/" icon="fa-solid fa-box-open" badge="v0.5" */>}}
One release URL, an asset table and checksums — all generated locally.
{{</* /card */>}}
{{</* card title="Keyboard navigation" link="https://docs.pgsty.com/docs/customize/keyboard/" icon="fa-solid fa-keyboard" */>}}
...
`hugo mod get github.com/pgsty/docs`. The recommended way; upgrading is one
version line.
{{</* /card */>}}
...
- `git submodule add`
- the theme lands in `themes/docs`
{{</* /card */>}}
{{</* /cards */>}}
```
...
```markdown {title="Source"}
{{</* cards */>}}
{{</* card title="The Docs shell" link="https://docs.pgsty.com/docs/about/features/" image="/images/docs.webp" image_alt="An Docs documentation page: sidebar, article and table of contents" */>}}
Sidebar, article, table of contents — each can be turned off on its own.
{{</* /card */>}}
{{</* card title="Release notes" link="https://docs.pgsty.com/docs/write/releases/" image="/images/releasenote.webp" decorative=true */>}}
...
Card images do not take part in [image zoom](/docs/image/#zoom) — the
...
cards. This site turns it on globally in `hugo.yaml`:
...
- Cards are not for long text: when a description runs past two lines, use a
  paragraph or a [callout](/docs/callout/).

## Related {#related}

- [Fields](/docs/fields/) — also has a native form and a shortcode form
- [Galleries](/docs/gallery/) — a grid of images
- [Badges](/docs/badge/) — inline status labels
- [Organizing content](https://docs.pgsty.com/docs/write/organize/) — sections, weights and landing pages
- [Configuration](https://docs.pgsty.com/docs/customize/config/) — `section_index` and friends
