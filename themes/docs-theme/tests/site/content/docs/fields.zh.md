...
| 内容是操作顺序 | 用[步骤](/zh/docs/steps/) |

表格形态在 GitHub 上仍然是一张可读的表，Docs 的 Markdown 输出也保持表格原样，这是默认选它的理由。
...
- [表格](/zh/docs/table/) — 属性行的其它取值与互斥规则
- [配置总览](https://docs.pgsty.com/zh/docs/customize/config/) — 站点参数全表就是用参数表写的
- [页面参数](https://docs.pgsty.com/zh/docs/write/frontmatter/) — front matter 全表
- [步骤](/zh/docs/steps/) — 顺序动作不要写成参数表
