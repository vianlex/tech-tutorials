...
![The Docs documentation shell: sidebar, article and table of contents](/images/docs.webp)
```
...
| Global resource `assets/images/…` | `![…](images/logo/docs.webp)` | Images several pages share, especially ones that need processing |
| Static directory `static/images/…` | `![…](/images/docs.webp)` | Large images and downloads that need no processing; supply `width`/`height` since the theme cannot measure them |
...
> has it; see [Configuration](https://docs.pgsty.com/docs/customize/config/)).
...
```markdown {title="Source"}
[![Go to the highlights page](/images/docs.webp)](https://docs.pgsty.com/docs/about/features/)

![Release card](/images/releasenote.webp)
{caption="Click the image for the release and download page" link="https://docs.pgsty.com/docs/write/releases/"}
```
...
[publishing books](https://docs.pgsty.com/docs/write/book/).
...
```markdown {title="Source"}
![Sidebar (light)](/images/docs.webp)
{class="only-light"}

![Sidebar (dark)](/images/docs.webp)
{class="only-dark"}
```
...
- [Publishing books](https://docs.pgsty.com/docs/write/book/) — lists of figures and `xref`
- [Branding](https://docs.pgsty.com/docs/customize/brand/) — where the site logo and favicon live
