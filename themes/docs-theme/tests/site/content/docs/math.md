...
[Configuration](https://docs.pgsty.com/docs/customize/config/). Delimiters must
...
- [Publishing books](https://docs.pgsty.com/docs/write/book/) — lists of equations and cross-page references
- [Configuration](https://docs.pgsty.com/docs/customize/config/) — the `markup.goldmark` keys
