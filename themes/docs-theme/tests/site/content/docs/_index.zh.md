...
个别组件另有前置条件：公式需要开启 Goldmark 的 passthrough，PlantUML 与 Draw.io 需要自建渲染服务，各页分别说明。完整的配置键见[配置总览](https://docs.pgsty.com/zh/docs/customize/config/)。
...
| [图片](/zh/docs/image/) | 图注、尺寸、缩放、编号与构建期图片处理 | `![说明](docs.webp)` |
