...
1. 替换三处内容，它就是你的站点。
   ...
   | 位置 | 替换为 |
   | --- | --- |
   | `hugo.yaml` 的 `title` | 你的站名 |
   | `hugo.yaml` 的 `baseURL` | 你的域名 |
   | `content/` | 你的内容 |
{.steps}
````
...
- [标签页](/zh/docs/tabs/) — 按平台分开的命令
- [提示块](/zh/docs/callout/) — 某一步里的前提与警告
- [代码块](/zh/docs/code/) — 步骤里的命令
- [卡片](/zh/docs/cards/) — 步骤做完之后的「下一步」
