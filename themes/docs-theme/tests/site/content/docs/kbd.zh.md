...
全站快捷键的完整清单见[键盘导航](https://docs.pgsty.com/zh/docs/customize/keyboard/)。
...
- [键盘导航](https://docs.pgsty.com/zh/docs/customize/keyboard/) — 全站快捷键清单与开关
- [命令面板](https://docs.pgsty.com/zh/docs/customize/panel/) — {{< kbd "Ctrl" "K" >}} 打开的面板
