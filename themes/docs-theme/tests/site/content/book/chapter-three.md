...
{{< fig num="3-1" id="fig-operations" src="/images/docs.webp" alt="Docs documentation site after publication" caption="The published site is checked as a reader sees it." width="600" height="300" />}}
...
<script>
  ...
  window.DocsEchartsFunctions.rtoPhase = function (params) {
