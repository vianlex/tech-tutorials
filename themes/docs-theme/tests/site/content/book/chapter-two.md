...
{{< fig num="2-1" id="fig-release" src="/images/releasenote.webp" alt="Docs release notes page" caption="A release note connects the shipped artifact to its verification evidence." width="600" height="300" />}}
...
9d3f0c1c7bd2f9b0a8b9a0f2c7c1c26f1e2ab0d1c4c6ba0d1e0a9f8c7b6a5d4e  docs-0.5.0.tar.gz
1a2b3c4d5e6f708192a3b4c5d6e7f80912a3b4c5d6e7f8091a2b3c4d5e6f70819  docs-0.5.0.zip
```
...
$ git tag -s v0.5.0 -m 'docs v0.5.0'
$ git push origin v0.5.0
To github.com:pgsty/docs.git
 * [new tag]         v0.5.0 -> v0.5.0
$ GOPROXY=https://proxy.golang.org go list -m github.com/pgsty/docs@v0.5.0
github.com/pgsty/docs v0.5.0
```
...
> gpg: Good signature from "Docs Release <release@example.org>" [ultimate]
> go: downloading github.com/pgsty/docs v0.5.0
> go: verifying github.com/pgsty/docs@v0.5.0: checksum matches
> ```
