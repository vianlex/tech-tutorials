...
title: Blog
type: blog
description: Real Docs release notes and engineering posts, wired to every blog feature.
weight: 20
...
Two sections below: the release notes are a numbered series, and the Docs posts
carry bylines resolved from the `authors` taxonomy.

![The Docs mark, shown here so the blog index carries a zoomable content image](/images/docs.webp)
