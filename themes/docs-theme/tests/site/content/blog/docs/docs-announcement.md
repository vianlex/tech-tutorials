---
title: Introducing the Docs implementation preview
linkTitle: Introducing Docs
date: 2026-08-08
aliases: [/blog/2026/docs-announcement/]
lastmod: 2026-08-08
description: >-
  Docs turns a directly customized Docsy codebase into a local-first, Hugo-only
...
Today we are publishing the Docs implementation preview: a directly evolved
...
Docs consolidates the genuinely reusable layer. Product matrices, portals,
...
Docs is not an optional skin. There is no `docs.enabled` flag, `params.docs.*`
...
and Docs components are committed with the theme. Node.js, npm, PostCSS,
...
Docs adds theme-owned Asciinema, ECharts, Infographic, document carousel,
...
Docs retains Docsy's content organization, front matter, documentation and blog
...
```sh
scripts/package-offline.sh /absolute/path/docs-preview.tar.gz preview
```
...
- [Implementation diary](/blog/docs/docs-implementation-diary/)
