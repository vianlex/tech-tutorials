---
title: 'Docs implementation diary: from copied shells to one theme'
linkTitle: Docs implementation diary
date: 2026-08-08
aliases: [/blog/2026/docs-implementation-diary/]
lastmod: 2026-08-08
description: >-
  A technical diary of the decisions, migrations, safety boundaries, tests, and
  documentation work behind the Docs implementation preview.
author: Docs maintainers
tags: [Docs]
---

Docs began with an awkward observation: several production documentation sites
...
This ruled out an attractive but costly shortcut: adding `params.docs.enabled`
...
and some paths invoked PostCSS. Docs moved the required sources and compiled
...
features, not merely JavaScript libraries. Docs refuses to invent a public
...
## Turning the sample into Docs docs
...
4. added the Docs product guide, announcement, and this implementation diary.
...
instructions are historical context, while the Docs architecture and migration
