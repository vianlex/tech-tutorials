---
title: Docs 0.4.0 — Scenario components for complete publishing workflows
linkTitle: Docs v0.4.0
date: 2026-08-14
lastmod: 2026-08-14
description: >-
  Docs 0.4.0 adds sequential reading and release surfaces, reusable landing
...
authors: [docs]
tags: [Docs, Release]
release_url: https://github.com/pgsty/docs/releases/tag/v0.4.0
series: [docs-releases]
series_weight: 4
---

Docs 0.4.0 delivers the complete Scenario Components system. The original design
...
```sh
hugo mod get github.com/pgsty/docs@v0.4.0
hugo mod tidy
hugo --gc --minify
```
...
[PRD 5 migration reference](https://github.com/pgsty/docs/blob/v0.4.0/docs/prd5-migration-guide.md).
...
[v0.3.0 to v0.4.0](https://github.com/pgsty/docs/compare/v0.3.0...v0.4.0).
