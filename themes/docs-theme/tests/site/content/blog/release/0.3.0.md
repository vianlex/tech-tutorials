---
title: Docs 0.3.0 — Authoring, navigation, and a lighter page
linkTitle: Docs v0.3.0
date: 2026-08-12
lastmod: 2026-08-12
description: >-
  Docs 0.3.0 adds enhanced code blocks and code groups, everyday content
...
series_weight: 3
release_url: https://github.com/pgsty/docs/releases/tag/v0.3.0
---
...
Docs 0.3.0 is the authoring and navigation release. Writing a page gets a modern
...
See the
[migration reference](https://github.com/pgsty/docs/blob/v0.3.0/docs/prd4-migration-guide.md)
...
ship: `technical`, which preserves the current Docs appearance, and `system`,
which uses the platform stack and requests no Docs brand fonts at all. Existing
...
See
[Typography tokens](https://github.com/pgsty/docs/blob/v0.3.0/docs/typography-tokens.md).
...
```sh
hugo mod get github.com/pgsty/docs@v0.3.0
hugo mod tidy
hugo --gc --minify
```
...
The 0.3.0 candidate is exercised through the sibling Docs project site, so the
...
[v0.2.1 to v0.3.0](https://github.com/pgsty/docs/compare/v0.2.1...v0.3.0).
