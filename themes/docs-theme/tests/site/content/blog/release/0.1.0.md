---
title: Docs 0.1.0 — A stable local-first foundation
linkTitle: Docs v0.1.0
date: 2026-08-08
lastmod: 2026-08-08
description: >-
  The first stable Docs release turns the implementation preview into a polished
...
Docs 0.1.0 is the first stable release of the Docs theme. It incorporates the
...
This release keeps the module path `github.com/pgsty/docs` and requires Hugo
...
Docs ships the styles, fonts, icons, local search, diagrams, API documentation
...
On tablets and phones, Docs moves the TOC, page actions, categories, and tags
...
system-theme and selected-theme combinations. Docs now declares the used
...
No content migration is required. If a site imports Docs partials or SCSS
...
| Module path                  | `github.com/pgsty/docs`                    |
...
The final 0.1.0 candidate was swept against the theme fixture and the Docs
...
See the [v0.1.0 source snapshot](https://github.com/pgsty/docs/tree/v0.1.0).
