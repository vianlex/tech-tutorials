---
title: Docs 0.2.0 — Richer content and sharper presentation
linkTitle: Docs v0.2.0
date: 2026-08-10
lastmod: 2026-08-10
description: >-
  Docs 0.2.0 adds composable homepage sections, theme-aware media, wordmarks,
...
series_weight: 2
release_url: https://github.com/pgsty/docs/releases/tag/v0.2.0
---

{{< release-card >}}

Docs 0.2.0 focuses on the parts readers and authors touch most: the homepage,
brand presentation, blog discovery, section indexes, and instructional content.
It also turns the Docs project site into a clearer bilingual reference for the
...
Docs also adds `params.wordmark`. A configured wordmark is used consistently in
...
The Docs project site now separates upstream Docsy history, Docs engineering
articles, and versioned Docs release notes into distinct bilingual sections.
...
[Docs components](/docs/components/) for the broader component model.
...
resource, or explicit `default_featured` exists, Docs now renders a clean
...
```sh
hugo mod get github.com/pgsty/docs@v0.2.0
hugo mod tidy
hugo --gc --minify
```
...
| Module path                      | `github.com/pgsty/docs`; unchanged   |
...
The 0.2.0 candidate is exercised through the sibling Docs project site so the
...
[v0.1.0 to v0.2.0](https://github.com/pgsty/docs/compare/v0.1.0...v0.2.0).
