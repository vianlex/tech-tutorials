---
title: mattpocock/skills 使用指南：25 个 Agent Skill 如何重建工程纪律
linkTitle: mattpocock/skills 指南
date: 2026-09-12
description: Matt Pocock 公开的私人 Agent Skill 集怎么用。覆盖四个失败模式与四类解法、两种安装方式、25 个已晋升 Skill 全景、CONTEXT.md 防污染知识库机制，以及 7 个 WMS 实战场景——需求访谈、TDD、Bug 诊断、工单拆解、会话交接、省 Token、非代码决策拷问。
authors: [vianlex]
tags: [Agent, Claude Code, Skill, TDD, 工程实践]
---
...
> [!WARNING]
> **注意**：方式 B 安装时，交互选项中务必勾选 `setup-matt-pocock-skills`；安装模式选 **Symlink**（多客户端共享一份源码，更新一键全局生效）。Windows 下技能文件位于 `C:\Users\<你>\.agents\skills\`。
